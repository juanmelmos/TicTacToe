...
public class LocalImposible extends JFrame {
	...
	protected WThreadImposible thread = new WThreadImposible(sqA);
	...
	public static void setTurnoPlayer(boolean turnoPlayer) {
		LocalImposible.turnoPlayer = turnoPlayer;
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFrame frame = new LocalImposible();
...
//		}
		...
		WThreadImposible.setPlayerMaquina(player);
	...
	public void send(ArrayList<SquareButton> sqA, int num) {
		...
		WThreadImposible.casillasMarcadas=count;
	}

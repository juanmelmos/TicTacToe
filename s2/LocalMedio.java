...
public class LocalMedio extends JFrame {
	...
	protected WThreadMedio thread = new WThreadMedio(sqA);
	...
	public static void setTurnoPlayer(boolean turnoPlayer) {
		LocalMedio.turnoPlayer = turnoPlayer;
	}
	...
	public static JButton getBtnJugarDeNuevo() {
		return btnJugarDeNuevo;
	}

	public static void setPlayer(String player) {
		LocalMedio.player = player;
	...
	public LocalMedio() {
		...
		WThreadMedio.setPlayerMaquina(player);

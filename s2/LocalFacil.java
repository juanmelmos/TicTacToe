...
public class LocalFacil extends JFrame {
	...
	protected WThreadFacil thread = new WThreadFacil(sqA);
	...
	public static void setTurnoPlayer(boolean turnoPlayer) {
		LocalFacil.turnoPlayer = turnoPlayer;
	}
	...
	public LocalFacil() {
		...
		WThreadFacil.setPlayerMaquina(player);
